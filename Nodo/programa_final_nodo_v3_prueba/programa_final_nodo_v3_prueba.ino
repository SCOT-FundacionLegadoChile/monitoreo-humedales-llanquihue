...
//
String node_ids[6] = {"prueba", "sarao_1", "baquedano_pasarela", "el_loto_isla", "el_loto_werner", "los_helechos_1"};
...
void loop() {
  ...
  aux = String(n)     + tab + 
        node_ids[node_count]       + tab + 
        String(random(10,28)) + tab + //String(temp)  + tab + 
        String(random(0,5)) + tab + //sensorvalue   + tab + 
